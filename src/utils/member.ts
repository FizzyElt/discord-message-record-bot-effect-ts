import { GuildMemberManager, MessageMentions, GuildMember, PermissionFlagsBits } from 'discord.js';
import { Effect, pipe } from 'effect';

export const findUserFromMembers = (idOrMention: string) => (members: GuildMemberManager) => {
