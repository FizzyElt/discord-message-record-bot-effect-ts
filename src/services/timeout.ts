import { Effect, Context, identity, Array as ReadonlyArray, pipe, Equal } from 'effect';
...
export const provideTimeoutInfoService = Effect.provideService(TimeoutInfoContext, choiceList);
